...
function AnalyticsTab({ links, profile, clickEvents, handleUpgrade, conversions }: any) {
    ...
    return (
        <div className="relative min-h-[500px] bg-white/80 dark:bg-[#121212] backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] dark:shadow-none p-2 transition-all duration-300">
            {isFree && (
