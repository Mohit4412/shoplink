...
const THEMES: StoreTheme[] = [
  ...
  { id: 'slate', name: '🌙 Slate', cardAnatomy: 'square-overlay', description: 'Dark and modern with bold typography. Tech and lifestyle products.', imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=400&q=80', preview: { bg: '#1e293b', card: '#334155', accent: '#60a5fa', text: '#f1f5f9', button: '#f1f5f9' } },
  { id: 'rose', name: '🌸 Rose', cardAnatomy: 'portrait', description: 'Soft pink tones with elegant typography. Beauty and wellness.', imageUrl: 'https://images.unsplash.com/photo-1522673607200-164d1b6ce486?auto=format&fit=crop&w=400&q=80', preview: { bg: '#fff1f2', card: '#FFFFFF', accent: '#e11d48', text: '#881337', button: '#e11d48' } },
  { id: 'forest', name: '🌲 Forest', cardAnatomy: 'editorial-row', description: 'Natural green with compact layout. Eco-friendly and organic products.', imageUrl: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=400&q=80', preview: { bg: '#f0fdf4', card: '#FFFFFF', accent: '#16a34a', text: '#14532d', button: '#16a34a' } },
  { id: 'ocean', name: '🌊 Ocean', cardAnatomy: 'landscape', description: 'Calm blue with wide cards. Travel and lifestyle.', imageUrl: 'https://images.unsplash.com/photo-1505142468610-359e7d316be0?auto=format&fit=crop&w=400&q=80', preview: { bg: '#f0f9ff', card: '#FFFFFF', accent: '#0284c7', text: '#0c4a6e', button: '#0284c7' } },
  { id: 'amber', name: '☀️ Amber', cardAnatomy: 'square-overlay', description: 'Warm golden tones with compact feel. Food and artisan goods.', imageUrl: 'https://images.unsplash.com/photo-1495195134817-aeb325a55b65?auto=format&fit=crop&w=400&q=80', preview: { bg: '#fffbeb', card: '#FFFFFF', accent: '#f59e0b', text: '#78350f', button: '#f59e0b' } },
  { id: 'vibe', name: '✨ Vibe', cardAnatomy: 'editorial-row', description: 'Bold purple with large typography. Creative and artistic products.', imageUrl: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?auto=format&fit=crop&w=400&q=80', preview: { bg: '#faf5ff', card: '#FFFFFF', accent: '#9333ea', text: '#581c87', button: '#9333ea' } },
];
