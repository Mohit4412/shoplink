...
import {
  ...
  MapPin, Globe, Recycle, Tag, Percent, Handshake, Zap,
...
const SECTION_SETTINGS_FIELDS: Record<string, SettingsField[]> = {
  ...
  'about': [
    ...
    { key: 'subtext', label: 'Description', placeholder: 'e.g. We craft quality products with care.' },
  ],
  'whatsapp-cta': [
    { key: 'heading', label: 'Heading',      placeholder: 'e.g. Chat with us on WhatsApp' },
